...
.setDescription(` **${message.author.username}** fait un calin à **${user.user.username}**`)
.setImage(randomhug)
.setColor(db.color)
...
var embed = new MessageEmbed()
.setDescription(`**${message.author.username}** fait un calin à **${member.user.username}**`)
.setImage(randomhug)
.setColor(db.color)
.setTimestamp()
.setAuthor(message.author.username, message.author.avatarURL({dynamic: true}))
...
var embed = new MessageEmbed()
.setDescription(`**${message.author.username}** fait un calin à **${client.user.username}**`)
.setImage(randomhug)
.setColor(db.color)
.setAuthor(message.author.username, message.author.avatarURL({dynamic: true}))
.setTimestamp()  
